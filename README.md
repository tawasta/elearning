...
--- | --- | --- | ---
[custom_website_slides_quiz](custom_website_slides_quiz/) | 17.0.1.0.0 |  | Simplifies eLearning quiz result by removing XP and progress visuals
...
[website_slides_certification_delay](website_slides_certification_delay/) | 17.0.1.0.0 |  | Enforce a delay between failed certification attempts in eLearning
[website_slides_channel_auto_archive_cron](website_slides_channel_auto_archive_cron/) | 17.0.1.0.0 |  | Enables setting an unpublish date for courses
[website_slides_channel_auto_remove_participant_after_x_days](website_slides_channel_auto_remove_participant_after_x_days/) | 17.0.1.0.0 |  | Enables revoking course access automatically per participant
[website_slides_channel_no_default_email_messaging](website_slides_channel_no_default_email_messaging/) | 17.0.1.0.0 |  | Clears the four email template fields that would be filled in by default
